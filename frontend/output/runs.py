...
		robot.tasks.drive_forward_gyro(distance=115,speed=20,),
		robot.tasks.turn_left(angle=45,speed=30,),
		robot.tasks.set_event(index=1,),
		[robot.tasks.wait_ms(time=1500,),robot.tasks.module_left_cw(distance=100,speed=90,),robot.tasks.trigger_event(index=1,)],
...
		robot.tasks.drive_forward_gyro(distance=560,speed=30,),
		robot.tasks.set_event(index=6,),
		[robot.tasks.module_right_cw(distance=1390,speed=100,),robot.tasks.trigger_event(index=6,)],
...
		robot.tasks.turn_left(angle=70,speed=20,),
...
		robot.tasks.module_right_cw(distance=80,speed=60,),
...
		robot.tasks.drive_forward_gyro(distance=400,speed=20,),
		robot.tasks.drive_backward(distance=350,speed=30,),
		robot.tasks.turn_right_on_spot(angle=105,speed=20,),
		robot.tasks.drive_forward_gyro(distance=600,speed=60,),], self.run_color)
...
		robot.tasks.module_right_ccw(distance=220,speed=30,),
		robot.tasks.drive_forward_gyro(distance=990,speed=40,),
		robot.tasks.wait_event(index=1,),
		robot.tasks.module_left_cw(distance=1250,speed=100,),
		robot.tasks.drive_forward_gyro(distance=1300,speed=30,),
		robot.tasks.module_left_ccw(distance=2100,speed=100,),
		robot.tasks.drive_backward_gyro(distance=250,speed=40,),
		[robot.tasks.module_right_cw(distance=170,speed=30,)],
		robot.tasks.drive_backward_gyro(distance=300,speed=40,),
		[robot.tasks.module_right_ccw(distance=450,speed=100,)],
		robot.tasks.drive_backward_gyro(distance=220,speed=80,),], self.run_color)
...
		robot.chain([robot.tasks.turn_right_on_spot(angle=45,speed=10,),
...
		robot.tasks.drive_forward_gyro(distance=180,speed=30,),
